...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    #this took some fildling it doesn't like floats :(
    W2_row_size = num_filters * input_dim[1]/2 * input_dim[2]/2
    self.params['W2'] = np.random.normal(scale=int(weight_scale), size=(int(W2_row_size), int(hidden_dim))) 
  ...
  def loss(self, X, y=None):
    ...
    #affine relu pass
    o_2, c_2 = affine_relu_forward(out_1, W2, b2)
    #affine pass
    o_3, c_3 = affine_forward(out_2, W3, b3)
    scores = o_3
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
